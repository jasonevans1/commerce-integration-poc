...
- EDS storefront integration (separate plan in storefront-poc repo)
...
| ---- | ------------------------------------------ | ---------- | ------- |
| 001  | Webhook action config + directory scaffold | -          | pending |
| 002  | Webhook handler 6-file implementation      | 001        | pending |
| 003  | Commerce webhooks.xml registration         | 001        | pending |
